                   ...
                   <form action="" class="form-horizontal row-border"  method="POST" id="spmsForm">
                      ...
                      <div id="divItems">
                        ...
                        <div class="form-group" id="row_1">
                          ...
                          <div class="col-md-3">
                            <center><label><b>Item Description</b></label></center>
                          </div>  
                          <div class="col-md-1">
                            <center><label><b>Qty</b></label></center>
                          </div>
                          <div class="col-md-1">
                            <center><label><b>Unit Cost</b></label></center>
                          </div>
                          <div class="col-md-1">
                        ...
                        <div class="form-group" id="row_1">
                          ...
                          <div class="col-md-3">
                            <!--  <input type="text" class="form-control" name="item[]" id="item" placeholder="" required>-->
                              ...
                              <select class="form-control" id="item" name="item[]" style="width:100%" onChange="showUnit(this.value, 1)" required>
                                     ...
                                     <div class="col-sm-12">
                                          ...
                                          -->
                                             <div class="col-offset-2 col-md-1">
                                              ...
                                              <br>
                                              <input type="text" class="form-control" id="requested_total_amount" name="requested_total_amount" readonly>
                                            </div> 
                                            <div class="col-offset-2 col-md-2">
                                            <br>
                                            <label><strong>Action</strong></label><br>
                                              <button type="submit" class="btn btn-info" style="width:70px;">Save</button><button type="button" class="btn btn-default" style="width:70px;" onclick="cancel_order()">Cancel</button>
                                            </div>
                                      </div>
                                 </div>
...
function clearForm()
{
  ...
  //                         '</div>'+
  //                         '<div class="col-md-1">'+
  //                           '<input type="text" class="form-control" name="total_cost[]" id="total_cost" placeholder="" required>'+
  //                         '</div>'+
  //                         '<div class="col-md-2">'+
  //                           '<input type="text" class="form-control" name="purpose[]" id="purpose" placeholder="">'+
  //                         '</div>'+
