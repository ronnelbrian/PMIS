...
<div id="page-content">
  <div id='wrap'>
    <div id="page-heading">
      <ol class="breadcrumb">
        <li>Administrator</li>
          <li>Approve Purchase Request</li>
      </ol>
    </div>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="panel panel-inverse">
              <div class="panel-heading">
                  <h4>Approve Purchase Request</h4>
                  <div class="options">
...
function loadtable()
{
  ...
  $('#spmsTable').dataTable({
      "serverSide": true,
      "sAjaxSource": "<?php echo base_url('Process/approve_purchase_requests')?>"+"?loadtable=true",
      "deferLoading": 10,
      "bPaginate": false,
...
function approve_(id, name){
  ...
  if (result) {
       $.ajax
        ({ type:"POST",
           async: true,
           url:"<?php echo base_url('Process/approve_purchase_requests')?>",
