          ...
          <div class="panel panel-inverse">
              ...
              <div class="panel-body collapse in">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%" id="spmsTable" class="table table-striped table-bordered datatables">
                      <thead>
                          <tr>
                              <th style="width : 15%">IR ID/RIS NO</th>
                              <th style="width:5%">Unit</th>
                              <th style="width : 10%">Desciption</th>
...
function loadtable()
{
  ...
  $('#spmsTable').dataTable({
      "serverSide": true,
      "sAjaxSource": "<?php echo base_url('Process/approve_item_requests')?>"+"?loadtable=true",
      "deferLoading": 10,
      "bPaginate": false,
       ...
       success: function(data)
        {
          ...
          if(data['mes'] == "Success")
          {
            ...
            if(check == 0)
                content+='<li class="current"><div class="wrap"><p class="title">Item Released</p><p class="subtitle">The Item request has been approved and released.</p></div></li>';
