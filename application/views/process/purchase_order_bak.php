                        ...
                        <div class="form-group"> 
                                     <div class="col-sm-12">
                                            ...
                                            <div class="col-offset-2 col-md-1">
                                              ...
                                              <br>
                                              <input type="text" class="form-control" id="discount_id" name="requested_unit">
                                            </div>
                                            <div class="col-offset-2 col-md-1">
        ...
        ({ type:"POST",
          ...
          //    {
           ...
           //  $('#requested_item').select({setVal:(data[0][14]}); 
            ...
            //document.getElementByID("supplier_").scrollIntoView();
            //  }
            //  else
            //    confirm('arzanan');
             },
  ...
  $('#divItems').append(' <input type="hidden" id="ctr" value = "1"/> '+
                        '<div class="form-group" id="row_1">'+
                          ...
                          '<div class="col-md-1" id="ctp_1" >'+
                            '<input type="number" class="form-control" name="unit[]" id="unit_1" onchange="computeTotal(1)" min = "0"  placeholder="" style="font-size:12px; text-align:right" required>'+
                          '</div>'+
         ...
         success: function(data)
          {
            ...
            $('#divItems').append('<div class="form-group" id="row_'+ctr+'">'+
                ...
                '<div class="col-md-1" id="ctp_'+ctr+'" >'+
                  '<input type="number" class="form-control" name="unit[]" id="unit_'+ctr+'" onchange="computeTotal('+ctr+')" placeholder="" min = "0" style="font-size:12px; text-align:right" required>'+
                '</div>'+
                '<div class="col-md-2" >'+
