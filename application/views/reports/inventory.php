        ...
        <div class="col-md-12">
          <div class="panel panel-inverse">
              <div class="panel-heading">
                  <h4>Inventory Report Filter/Parameters</h4>
                  <div class="options">
              ...
              <div class="panel-body" id="divstyle" style="display:block;">
                   <form action="" class="form-horizontal row-border"  method="POST" id="spmsForm">
                      <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <select id="product" name="product" style = "width:100%" class="populate">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <select multiple="multiple" id="columns" name="columns[]" style = "width:100%">
                                ...
                                <option value="current_stock" selected>Current Stock</option>
                      ...
                      <div class="form-group">
                          <label class="col-sm-2 control-label">Select Item Status</label>
                          <div class="col-sm-2">
...
function pdf_()
{
  ...
  window.open('<?php echo base_url("Report/inventory_pdf")?>'+'?'+data);
}

function excel_()
{
  var data = $('#spmsForm').serialize();
  window.open('<?php echo base_url("Report/inventory_excel")?>'+'?'+data);
}
