              ...
              <div class="panel-body" id="divstyle" style="display:none;">
                   <form action="" class="form-horizontal row-border"  method="POST" id="spmsForm">
                      ...
                      <div class="form-group">
                          <label class="col-sm-2 control-label">Property Category Name<span style="color:red">*</span></label>
                          <div class="col-sm-4">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%" id="spmsTable" class="table table-striped table-bordered datatables">
                      <thead>
                          <tr>
                              ...
                              <th style="width : 20%">Property Category</th>
                              <th style="width : 70%">Property Subcategory</th>
                          </tr>
                      </thead>
                      <tbody>
    ...
    <div class="modal-dialog" style="width:800px">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title">Add Property Subcategory</h3>
        </div>
        <form action="" class="form-horizontal" id="spmsForm2"  enctype="multipart/form-data">
          ...
          <div class="modal-body" id="appendList">
            <div class="form-group">
                <label class="col-sm-4 control-label">Property Subcategory Description<span style="color:red">*</span></label>
                <div class="col-sm-8">
...
function loadtable()
{
  ...
  $('#spmsTable').dataTable({
      "serverSide": true,
      "sAjaxSource": "<?php echo base_url('Admin/property_category')?>"+"?loadtable=true",
      "deferLoading": 10,
      "bPaginate": false,
...
function delC(id, name){
  ...
  if (result) {
       $.ajax
        ({ type:"POST",
           async: true,
           url:"<?php echo base_url('Admin/property_category')?>",
    ...
    $.ajax({
      ...
      success: function(data)   
      {
        if(data['mes'] == 'Success')
        {
          ...
          alerts('New Property Category has been added.','s');
          loadtable();
          clearForm();
        }
        else
